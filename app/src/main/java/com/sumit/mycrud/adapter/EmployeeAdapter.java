...
public class EmployeeAdapter extends RecyclerView.Adapter<EmployeeAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull EmployeeAdapter.ViewHolder holder, int position) {
        ...
        Glide.with(context)
                .load("https://i.pravatar.cc/150?img="+(position+1))
                .into(holder.profile);
        ...
        if(employee.getEmp_status().equals("ACTIVE")){
            ...
            holder.delete.setOnClickListener(view -> {
                try {
                    employee.setEmp_status("INACTIVE");
            ...
            holder.delete.setOnClickListener(view -> {
                try {
                    ...
                    holder.edit.setVisibility(View.VISIBLE);
                    holder.delete.setForeground(context.getDrawable(android.R.drawable.ic_menu_delete));
                    this.notifyDataSetChanged();
                } catch (IOException e) {
                    e.printStackTrace();
                }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            this.profile = itemView.findViewById(R.id.profilePic);
